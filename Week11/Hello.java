...
public class Hello {
    ...
    /*2. Extend/Modify the above program to print two additional lines: This is my first program I am on module ST4003CEM System.out.print (not println) and produces the same output.*/
...
*/
        ...
        System.out.println("'mush' better if you learn");
        System.out.println("the rulers of \"escape sequences \"");
        System.out.println("Also, \"\" represnets an empty");
