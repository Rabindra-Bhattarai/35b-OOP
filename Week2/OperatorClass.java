public class OperatorClass {
    public static void main(String[] args) {
        ...
        System.out.println("Less than " + (rNum2 < rNum2));
        ...
        /*Unary Operator */
        int uNum1 = 10;
        uNum1++; //uNum1 = uNum1 +1; //Change value in next line
        ++uNum1; // changes value in the same line
        ...
        */
         ...
         * if expression is true it return after the "?"
         * if expression is false it return after the ":"
         */
